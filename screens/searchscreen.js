...
const searchscreen = (props) => {
  ...
  useEffect(() => {
    fetch('https://62b05551b0a980a2ef509677.mockapi.io/AnimFri')
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: '#1E1B26', paddingVertical: 115, marginTop:-115}}>
      <View style={styles.container}>
        <TextInput
          ...
          right={<TextInput.Icon name="account-search-outline"/>}
        />
        <FlatList
